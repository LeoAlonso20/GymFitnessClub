...
export default function LengMenu() {
  ...
  return (
    <React.Fragment>
      ...
      >
          {/* https://www.flaticon.com/free-icon/brazil_630591?related_id=630591&origin=pack */}
        <div className='container-options-menu-user'>
          <MenuItem sx={{borderRadius: '8px', padding: '6px 16px', display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '94%'}} onClick={handleClose}>
            ...
            <p className='name-user option-text'>Español</p>
          </MenuItem>
          <MenuItem sx={{borderRadius: '8px', padding: '6px 16px', display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '94%'}} onClick={handleClose}>
          <p className='name-user option-text'>Inglés</p>
          </MenuItem>
          <MenuItem sx={{borderRadius: '8px', padding: '6px 16px', display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '94%'}} onClick={handleClose}>
            <p className='name-user option-text'>Chino</p>
          </MenuItem>
          <MenuItem sx={{borderRadius: '8px', padding: '6px 16px', display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '94%'}} onClick={handleClose}>
            <p className='name-user option-text'>Francés</p>
          </MenuItem>
          <MenuItem sx={{borderRadius: '8px', padding: '6px 16px', display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '94%'}} onClick={handleClose}>
            <p className='name-user option-text'>Portugués</p>
          </MenuItem>
          <MenuItem sx={{borderRadius: '8px', padding: '6px 16px', display: 'flex', justifyContent: 'flex-start', alignItems: 'center', width: '94%'}} onClick={handleClose}>
            <p className='name-user option-text'>Italiano</p>
          </MenuItem>
        </div>
      </Menu>
    </React.Fragment>
